...
yargs
  ...
  .command(
    ...
    'Generate code from a GraphQL schema and query documents',
    {
      ...
      "skip-swift-import-statement": {
        demand: false,
        describe: "For Swift targets, do not add `import Apollo` to the top of the autogenerated file `API.swift`",
        default: false
      }
    },
    argv => {
      ...
      const options = {
        ...
        skipSwiftImportStatement: argv["skip-swift-import-statement"]
      };
