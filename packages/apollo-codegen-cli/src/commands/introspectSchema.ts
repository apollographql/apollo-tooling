...
import { buildASTSchema, graphql, parse, ExecutionResult } from 'graphql';
import { introspectionQuery } from 'graphql/utilities';

import { ToolError } from 'apollo-codegen-utilities'

export async function introspect(schemaContents: string): Promise<ExecutionResult> {
