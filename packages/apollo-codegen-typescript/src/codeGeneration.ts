import { LegacyCompilerContext, LegacyInlineFragment, LegacyFragment, LegacyField, LegacyOperation } from 'apollo-codegen-compiler';
import {
  GraphQLError,
  getNamedType,
  isCompositeType,
...
import { CodeGenerator } from 'apollo-codegen-utilities';
