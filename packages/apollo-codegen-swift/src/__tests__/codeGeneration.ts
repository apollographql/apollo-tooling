...
// Generate a version with public access level
describe("Swift code generation public access level", () => {
  ...
  beforeEach(() => {
    generator = new SwiftAPIGenerator({
      ...
      fragments: undefined,
      options: { swiftAccessLevel: `public` }
    });
  });
...
// Generate a version with internal access level
describe("Swift code generation internal access level", () => {
  let generator: SwiftAPIGenerator;
  ...
  beforeEach(() => {
    generator = new SwiftAPIGenerator({
      ...
      operations: undefined,
      fragments: undefined,
      options: { swiftAccessLevel: "internal" }
    });
  });
