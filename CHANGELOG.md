...
- `apollo-codegen-swift`
  - Treat `mergeInFieldsFromFragmentSpreads` as false in Swift codegen when flag isn't specified. Fixes [#537](https://github.com/apollographql/apollo-cli/issues/537). [@martijnwalraven](https://github.com/martijnwalraven))
